...
function graficoFaixaEtaria(req, res) {
  dashAdminModel.graficoFaixaEtaria()
    .then((resultado) => {
      res.status(200).json(resultado); // Sempre retorna JSON, mesmo que vazio
    })
    .catch((erro) => {
      console.error("Houve um erro ao buscar os dados: ", erro.sqlMessage);
